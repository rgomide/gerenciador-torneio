...
const DropdownLoader = ({ placeholder, label, loadRecords, minCharacters = 2, onChange }) => {
  ...
  useEffect(() => {
    const fetchOptions = async () => {
      ...
      setIsLoading(true)
      try {
        const response = await loadRecords(searchTerm)
  ...
  }, [searchTerm, loadRecords, minCharacters])
