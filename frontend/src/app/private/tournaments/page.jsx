        ...
        <TableBody>
          {tournaments.map((tournament) => (
            <TableRow key={tournament.id}>
              ...
              <TableCell className="font-medium">{formatDate(tournament.createdAt, true)}</TableCell>
              <TableCell className="font-medium">{formatDate(tournament.updatedAt, true)}</TableCell>
