        ...
        <TableBody>
          {institutions.map((institution) => (
            <TableRow key={institution.id}>
              ...
              <TableCell className="font-medium">{formatDate(institution.createdAt, true)}</TableCell>
              <TableCell className="font-medium">{formatDate(institution.updatedAt, true)}</TableCell>
